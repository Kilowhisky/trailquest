...
- Scaffold a small Vite + React + TypeScript app.
- Add map rendering.
- Add static quest and access-zone fixtures.
- Implement geofence check-ins.
- Implement scoring and badges.
- Add AI usage notes after implementation begins.
